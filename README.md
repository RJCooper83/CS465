...
Skills I’ve gained include: <BR>

Working with the MEAN stack<BR>
Designing and consuming REST APIs<BR>
Using Angular to build SPAs with reusable components<BR>
Writing secure login functionality with JWT<BR>
Testing APIs and handling error responses<BR>
<BR>
